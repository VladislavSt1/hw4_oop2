...
public class Triangle extends Figure implements Drawable{
    ...
    @Override
    public void draw(){
        System.out.println("Нарисован треугольник черным цветом с координатами: (" + getVertex1() + "; " + getVertex2() + "; " + getVertex3()  + ")");
    }
    @Override
    public void draw(Color color){
        System.out.println("Нарисован треугольник " + color + " цветом с координатами: (" + getVertex1() + "; " + getVertex2() + "; " + getVertex3()  + ")");
    }
