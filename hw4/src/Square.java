...
public class Square extends Rectangle implements Drawable{
    ...
    @Override
    public void draw(){
        System.out.println("РНарисован квадрат черным цветом с координатами: (" + getVertex1() + ", "+ getVertex2() + ", " + getVertex3() + ", " + getVertex4() + ")");
    }
    @Override
    public void draw(Color color){
        System.out.println("НАрисован квадрад " + color + " цветом с координатами: (" + getVertex1() + ", "+ getVertex2() + ", " + getVertex3() + ", " + getVertex4() + ")");
    }
}