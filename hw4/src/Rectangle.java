...
public class Rectangle extends Figure implements Drawable {
    ...
    @Override
    public void draw(){
        System.out.println("Нарисован прямоугольник черным цветом с координатами: (" + getVertex1() + ", "+ getVertex2() + ", " + getVertex3() + ", " + getVertex4() + ")");

    }
    @Override
    public void draw(Color color){
        System.out.println("Нарисован прямоугольник " + color + " цветом с координатами: (" + getVertex1() + ", "+ getVertex2() + ", " + getVertex3() + ", " + getVertex4() + ")");
    }
}